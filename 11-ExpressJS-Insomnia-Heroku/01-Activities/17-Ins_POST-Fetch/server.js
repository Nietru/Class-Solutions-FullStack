...
app.post("/api/reviews", (req, res) => {
  ...
  if (product && review && username) {
    // Variable for the object we will save, for a new review:
    const newReview = {
      product,
      review,
      username,
...
// This activity is where we start connecting the back-end (we have been doing) to the front-end stuff.
